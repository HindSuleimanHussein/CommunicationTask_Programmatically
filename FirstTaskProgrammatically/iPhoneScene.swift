...
class iPhoneScene: UIViewController {
    ...
    func configureAppleProductScene() {
        ...
        appleImageView.image = UIImage(named: "2S1T")

        NSLayoutConstraint.activate([
            appleImageView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -50),
            appleImageView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 50),
